...
# clean
rm $CMSSW_BASE/src/FastSimulation/Configuration/python/HLT_1E31_cff.py
rm $CMSSW_BASE/src/FastSimulation/Configuration/test/ExampleWithHLT_1E31.log
rm $CMSSW_BASE/src/FastSimulation/Configuration/python/blockHLT_1E31_cff.py
rm AODWithHLT.root

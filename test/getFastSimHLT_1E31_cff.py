...
# Usage: ./getFastSimHLT_1E31_cff.py <Version from ConfDB> <Name of cff file> <optional L1 Menu> <optional subset of paths>
###TABLE FOR 1E31 
...
##HLTL3PixelIsolFilterSequence has been removed 
        if line.find("HLTL3PixelIsolFilterSequence = ") == 0:
            ...
            if line.find("//") == 0 or line.find("#") == 0:
                ...
                print "#   - InputObjects set to l1extraParticles"
                ...
                print "# See FastSimulation/Configuration/test/getFastSimHLT_1E31_cff.py for other documentation"

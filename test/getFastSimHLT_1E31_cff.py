...
###PAT *** for now REMOVE the new Alca Streams
        ...
        paths += "-HLT_IsoTrack_L1JEC,"
        paths += "-HLT_IsoTrackHB_L1JEC,"
        paths += "-HLT_IsoTrackHE_L1JEC,"
        paths += "-HLT_HcalNZS_L1JEC,"
        paths += "-AlCa_EcalPi0_L1JEC,"
        paths += "-AlCa_EcalEta_L1JEC,"
...
##HLTL3PixelIsolFilterSequence has been removed
        if line.find("HLTL3PixelIsolFilterSequence = ") == 0:
            ...
            if line.find("//") == 0 or line.find("#") == 0:
                ...
                print "#   - InputObjects and GMTReadoutCollection set to l1extraParticles"

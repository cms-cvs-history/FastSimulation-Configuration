...
$CMSSW_BASE/src/FastSimulation/Configuration/test/getFastSimHLTcff.py /dev/CMSSW_2_1_0_pre5/HLT/V60 "$CMSSW_BASE/src/FastSimulation/Configuration/python/HLT_cff.py" "$CMSSW_BASE/src/FastSimulation/Configuration/python/blockHLT_cff.py" "$CMSSW_BASE/src/FastSimulation/Configuration/test/ExampleWithHLT_cfg.py" "L1Menu2008_2E30" "All" 
#"HLTriggerFirstPath"
#"All"

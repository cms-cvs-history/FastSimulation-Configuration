...
# NOTE: If you choose to run a subset of the HLT, you MUST specify the L1 Menu used
    $CMSSW_BASE/src/FastSimulation/Configuration/test/getFastSimHLTcff.py /dev/CMSSW_2_1_X_2008-05-06-0200/HLT/V19 $CMSSW_BASE/src/FastSimulation/Configuration/test/HLT.cff
